                                ...
                                <form id="ads-create" action="/Branch/create" method="post" enctype="multipart/form-data">
                                    <div class="grid grid-cols-12 gap-5">
                                        <div class="col-span-12">
                                            <label for="title" class="font-medium">Ism</label>
                                            <input name="name" id="title" type="text" class="form-input mt-2" placeholder="Ism :">
                                        </div>
                                        <div class="col-span-12">
                                            <label for="title" class="font-medium">Manzil</label>
                                            <input name="address" id="title" type="text" class="form-input mt-2" placeholder="Manzil :">
                                        </div>
                                    </div>
